...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Sai Durga CADD Projects" },
      { name: "description", content: "Precision engineering drawings and CAD solutions." },
      { property: "og:site_name", content: "Sai Durga CADD Projects" },
